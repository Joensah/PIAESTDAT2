...
//"C:/Users/enriq/source/repos/PIAESTDAT2/Indice.bin"
void Guardar_usuarios() {
	...
	case 1:
		//Usuarios
		gusuario.open("C:/Users/enriq/source/repos/PIAESTDAT2/usuario.bin", ios::out | ios::trunc | ios::binary);
		if (gusuario.is_open()) {
			usuario* aux = inicio_uc;
			if (inicio_uc != NULL) {
				while (aux->siguiente != inicio_uc) {
	...
	case 2:
		//Personas
		gciudadano.open("C:/Users/enriq/source/repos/PIAESTDAT2/ciudadanos.bin", ios::out | ios::trunc | ios::binary);
	...
	case 3:
		//vacunas 
		gvacuna.open("C:/Users/enriq/source/repos/PIAESTDAT2/vacunas.bin", ios::out | ios::trunc | ios::binary);
		if (gvacuna.is_open()) {
			vacuna* aux_v = inicio_v;
			if (inicio_v != NULL) {
				while (aux_v->siguiente != inicio_v) {
	...
	case 4:
		...
		char aux_fecha[100];
		char aux_fecha2[100];
		/**/gcarnet.open("C:/Users/enriq/source/repos/PIAESTDAT2/carnet.bin", ios::out | ios::trunc | ios::binary);
		if (gcarnet.is_open()) {
			int aux_save = 0;
...
void Cargar_usuarios() {
	...
	//           C:/Users/enriq/source/repos/PIAESTDAT2
	archivo.open("C:/Users/enriq/source/repos/PIAESTDAT2/usuario.bin", ios::in | ios::binary);
	if (archivo.is_open())
	{
...
void Cargar_ciudadanos() {
	...
	archivo.open("C:/Users/enriq/source/repos/PIAESTDAT2/ciudadanos.bin", ios::in | ios::binary);
	if (archivo.is_open())
	{
...
void Cargar_vacunas()
{
	...
	archivo.open("C:/Users/enriq/source/repos/PIAESTDAT2/vacunas.bin", ios::in | ios::binary);
	if (archivo.is_open())
	{
...
void Cargar_carnet() {
	ifstream archivo("C:/Users/enriq/source/repos/PIAESTDAT2/carnet.bin", ios::in | ios::binary);
	int aux_load = 0;
...
void Guardar_indicee() {
	ofstream ID;
	ID.open("C:/Users/enriq/source/repos/PIAESTDAT2/Indices.bin", ios::out | ios::binary | ios::trunc);
	if (ID.is_open()) {
		ID << indice_carnet;
		ID.close();
		return;
...
void Cargar_indice() {
	ifstream ID;
	ID.open("C:/Users/enriq/source/repos/PIAESTDAT2/Indices.bin", ios::in | ios::binary);
	if (ID.is_open()) {
		ID >> indice_carnet;
		ID.close();
		return;
...
void Guardar_reportes() {
	...
	greportes.open("C:/Users/enriq/source/repos/PIAESTDAT2/reportes.csv", ios::out | ios::trunc | ios::binary);
	 ...
	 case ID_MODIFICAR_CARNET: {
			 DialogBox(NULL, MAKEINTRESOURCE(V_EditarCarnet), handler, (DLGPROC)Editar_Carnet);
				 break;
								   ...
								   //REPORTE Y BUSQUEDA
	/*case ID_REPORTE: {
			DialogBox(NULL, MAKEINTRESOURCE(REP_PERSONAS), handler, (DLGPROC)Reportes);
			   break;
		 }*/
